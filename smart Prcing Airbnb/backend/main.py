...
def load_df() -> pd.DataFrame:
    if not CSV_PATH.exists():
        # Fallback demo dataset so /api/listings and /api/pricing keep working
        # even when Airbnb_Open_Data.csv is not present locally.
        return pd.DataFrame(
            [
                {
                    "id": 10001,
                    "NAME": "Soho Studio Loft",
                    "neighbourhood": "Soho",
                    "neighbourhood group": "Manhattan",
                    "room type": "Entire home/apt",
                    "price": 220,
                    "review rate number": 4.6,
                    "number of reviews": 148,
                    "availability 365": 210,
                    "lat": 40.7233,
                    "long": -74.0020,
                ...
                {
                    "id": 10003,
                    "NAME": "Queens Private Room Near Subway",
                    "neighbourhood": "Astoria",
                    "neighbourhood group": "Queens",
                    "room type": "Private room",
                    "price": 95,
                    "review rate number": 4.4,
                    "number of reviews": 89,
                    "availability 365": 260,
                    "lat": 40.7644,
                    "long": -73.9235,
                    "instant_bookable": "true",
                },
...
@limiter.limit("30/minute")
def kill_switch(request: Request, body: KillSwitchBody) -> Dict[str, Any]:
